...
trait DockerNative { outer: JavaModule =>
    ...
    trait DockerNativeConfig extends mill.Module with NativeImage {
         ...
         * [[https://docs.docker.com/engine/reference/builder/#expose ports]]
         ...
         *
         * See also the Docker docs on
         * [[https://docs.docker.com/engine/reference/builder/#env ENV]] for
         * more information.
         */
         ...
         *
         * See also the Docker docs on
         * [[https://docs.docker.com/engine/reference/builder/#run RUN]] for
         * more information.
         */
         ...
         * [[https://docs.docker.com/engine/reference/builder/#user USER]] for
         * more information.
         */
        def user: T[String] = ""
